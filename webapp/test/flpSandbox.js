		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#anibalmafdesigner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anibalmafdesigner-display": {
								"semanticObject": "anibalmafdesigner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anibal.ma.fdesigner",
									"url": sap.ui.require.toUrl("anibal/ma/fdesigner")
								}
							}
						}
					}
